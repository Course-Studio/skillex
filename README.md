...
- **Instant retrieval** — SQLite index with structured queries plus keyword search over skill `name`, `description`, topics, and tags. No document browsing, no embeddings.
